$(document).ready(function() {
    ...
    $("#InlineMenu").MonthPicker({
        ...
        OnAfterChooseMonth: function(selectedDate) {
            ...
            m_data = selectedDate.toLocaleDateString("en-US", options)
            $('#month_data').val(m_data)
            // $('#month_data').html(selectedDate.toLocaleDateString("en-US", options))
            // alert(selectedDate.toLocaleDateString("en-US", options))
            // console.log(selectedDate.toLocaleDateString("en-US", options))
